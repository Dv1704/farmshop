...
const ProductsList = () => {
  ...
  // Fetch products on component mount (page load)
  useEffect(() => {
    fetchAllProducts();
  }, [fetchAllProducts]);
  ...
  return (
    <motion.div
      className="bg-green-50 shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto"
    ...
    >
      {loading ? (
        ...
        <table className="min-w-full divide-y divide-green-300">
          ...
          <tbody className="bg-green-50 divide-y divide-green-300">
            {products?.map((product) => (
              <tr key={product._id} className="hover:bg-green-100">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-green-700">${product.price.toFixed(2)}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <button
                    ...
                    className={`p-1 rounded-full ${
                      product.isFeatured ? "bg-yellow-400 text-green-900" : "bg-green-300 text-green-900"
